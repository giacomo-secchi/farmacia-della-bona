...
$content = <<<HTML
	<!-- wp:cover {"url":"{$hero_image['url']}","dimRatio":50,"overlayColor":"{$hero_overlay_color_palette}","isUserOverlayColor":true,"isDark":true,"namespace":"hero","align":"full","className":"is-style-background-2","style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}}},"layout":{"type":"constrained"}} -->
	<div class="wp-block-cover alignfull is-dark is-style-background-2" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)"><img class="wp-block-cover__image-background" alt="" src="{$hero_image['url']}" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-{$hero_overlay_color_palette}-background-color has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:columns {"verticalAlignment":"center","align":"wide","powderMotion":true,"powderMotionEffect":"fadeInUp","powderDuration":1,"powderMotionDistance":"60"} -->
