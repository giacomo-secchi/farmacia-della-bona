 ...
 * Slug: farmacia-della-bona/hero-department
 * Categories: hero, banner
 */
?>

<!-- wp:cover {"url":"hero_image","dimRatio":50,"overlayColor":"hero_overlay_color","isUserOverlayColor":true,"isDark":false,"namespace":"hero-department","align":"center","className":"is-style-background-2","style":{"spacing":{"margin":{"top":"0px","bottom":"0px"},"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover aligncenter is-style-background-2" style="margin-top:0px;margin-bottom:0px;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)"><img class="wp-block-cover__image-background" alt="" src="hero_image" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background hero_overlay_color_palette_theme has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:columns {"verticalAlignment":"center","align":"wide","powderMotion":true,"powderMotionEffect":"fadeInUp","powderDuration":1,"powderMotionDistance":"60"} -->
